...
/**
 * Presentational only for now — wired up to /api/chat in a later phase.
 */
export function ChatBar() {
  return (
    <div className="fixed left-0 right-0 w-full max-w-[430px] mx-auto px-6 z-40 pointer-events-none flex justify-center bottom-6">
      <div className="pointer-events-auto bg-surface/90 backdrop-blur-md rounded-pill border border-border shadow-[0_8px_30px_rgb(0,0,0,0.12)] p-2 pr-4 flex items-center gap-3 w-[90%] transition-transform hover:scale-[1.02]">
        <button
          aria-label="Add"
